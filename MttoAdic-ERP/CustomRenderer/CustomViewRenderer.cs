...
namespace MttoAdic_ERP.CustomRenderer
{
    /// <summary>
...
#else
            Image image1 = Image.FromFile("../../../../Resources/Background.png");
            Image image2 = Image.FromFile("../../../../Resources/Pointer.png");
#endif
            using (image1)
            {
...
#else
            Image image = Image.FromFile("../../../../Resources/Flight_Progress-01.png");
#endif
            using (image)
            {
#if NETCORE
...
#else
                Image pointer = Image.FromFile("../../../../Resources/Pointer.png");
#endif
                using (pointer)
                {
